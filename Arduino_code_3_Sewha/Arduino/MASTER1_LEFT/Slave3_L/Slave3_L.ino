...
#define NUMPIXELS3 28 // Number of Pixies in the strip
...
const int m_totalBufferSize = (NUMPIXELS3 + 2) * 3; // 6 bytes are for the start and end bytes
