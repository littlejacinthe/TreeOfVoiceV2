...
#define NUMPIXELS5 25 // Number of Pixies in the strip
#define PIXIEPIN  5 // Pin number for SoftwareSerial output to the LED chain

SoftwareSerial pixieSerial(-1, PIXIEPIN);
Adafruit_Pixie strip = Adafruit_Pixie(NUMPIXELS5, &pixieSerial);

const int m_totalBufferSize = NUMPIXELS5  * 3; // 6 bytes are for the start and end bytes
